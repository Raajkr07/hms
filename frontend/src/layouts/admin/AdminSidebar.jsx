...
const links = [
  { name: 'Dashboard', url: '/admin/dashboard', icon: <IconDashboard stroke={1.5} /> },
  { name: 'Doctors', url: '/admin/doctors', icon: <IconStethoscope stroke={1.5} /> },
  { name: 'Users', url: '/admin/users', icon: <IconUsers stroke={1.5} /> },
  { name: 'Donations', url: '/admin/donations', icon: <IconClipboardList stroke={1.5} /> },
  { name: 'Inventory', url: '/admin/inventory', icon: <IconPackage stroke={1.5} /> },
  { name: 'Requests & Matches', url: '/admin/requests', icon: <IconClipboardList stroke={1.5} /> },
...
const Sidebar = ({ collapsed, onMouseEnter, onMouseLeave, onScroll, freezeScroll = false }) => {
