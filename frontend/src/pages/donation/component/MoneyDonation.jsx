...
export default function MoneyDonation({ plans = pricingPlans, onSubmit, darkMode = true }) {
  ...
  const getSelectedAmount = () => {
    if (customAmount && Number(customAmount) >= 500) {
  ...
  const validate = () => {
    if (getSelectedAmount() < 500) {
      setError('Minimum donation amount is ₹500.');
      return false;
    }
    if (!form.name.trim()) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccessMessage('Thank you for your donation! Your payment will be processed within 2-3 business days.');
      setSelectedPlan(null);
      setCustomAmount('');
      setForm({
        name: '',
  ...
  return (
    <section className="dark:bg-black bg-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {plans.map((plan, idx) => (
            <div
              ...
              className={`relative cursor-pointer transition-transform duration-300 transform border-none hover:scale-105 outline-none ${
          ...
          <div className="bg-gradient-to-br from-white to-blue-50 dark:from-black dark:to-slate-700 rounded-3xl shadow-2xl p-8">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={getSelectedAmount() < 500 || loading}
                type="button"
                ...
                aria-disabled={getSelectedAmount() < 500 || loading}
              >
