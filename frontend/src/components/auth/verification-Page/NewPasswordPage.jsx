        ...
        <main className="min-h-screen bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800 relative overflow-hidden flex flex-col md:flex-row">
            <div aria-hidden="true" className="hidden md:block md:flex-1 relative select-none">
                ...
                <div className="relative z-10 pt-4 pl-6 flex flex-col justify-between h-full text-white">
                    ...
                    <footer className="text-teal-200 text-sm mt-auto select-text">
                        © 2025 HopeMeds. Fighting medicine wastage together.
                    </footer>
                </div>
            </div>
                        ...
                        <>
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    className={`w-full rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-500 transition ${passwordError ? 'border-red-500' : 'border-gray-300'}`}
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    className={`w-full rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-500 transition ${confirmPasswordError ? 'border-red-500' : 'border-gray-300'}`}
